...
*Note:* Most commands are owner-only`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://files.catbox.moe/0y0bgc.jpg` }, // Replace with privacy-themed image if available
                caption: privacyMenu,
                contextInfo: {
...
async (conn, mek, m, { from, l, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        await conn.sendMessage(from, { text: "✔️ *New Bio Added Successfully*" }, { quoted: anony });
    } catch (e) {
...
╰────────────────────`;
        await conn.sendMessage(from, { text: puka }, { quoted: anony });
    } catch (e) {
        reply('🚫 *An error occurred!*\n\n' + e);
        l(e);
    }
