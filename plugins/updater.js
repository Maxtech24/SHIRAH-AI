...
cmd({
    ...
    try {
        ...
        const { data: commitData } = await axios.get("https://github.com/Maxtech24/SHIRAH-AI/commits/main", {
            headers: {
                'User-Agent': '𝙎𝙃𝙄𝙍𝘼𝙃_𝘼𝙄'
            }
        });
        ...
        if (latestCommitHash === currentHash) {
            return await conn.sendMessage(from, {
                text: "✅ *SHIRAH-AI is already up-to-date!*",
                ...newsletterConfig
            }, { quoted: anony });
        }
        ...
        const { data: zipData } = await axios.get("https://github.com/Maxtech24/SHIRAH-AI/archive/main.zip", { 
        ...
        // Copy updated files
        const sourcePath = path.join(extractPath, "SHIRAH-AI-main");
        ...
        await conn.sendMessage(from, {
            image: { 
                url: "https://files.catbox.moe/0y0bgc.jpg"
            },
...
cmd({
    ...
    try {
        ...
        await conn.sendMessage(from, {
            text: "🔍 *Checking for 𝙎𝙃𝙄𝙍𝘼𝙃_𝘼𝙄 updates...*",
            ...newsletterConfig
        }, { quoted: mek });

        // Fetch the latest commit info from GitHub
        const { data: commitData } = await axios.get("https://api.github.com/Maxtech24/SHIRAH-AI/commits/main", {
            headers: {
                'User-Agent': '𝙎𝙃𝙄𝙍𝘼𝙃_𝘼𝙄'
            },
            timeout: 10000
        ...
        let changelog = "";
        try {
            const { data: compareData } = await axios.get(`https://api.github.com/Maxtech24/SHIRAH-AI/compare/${currentHash}...${latestCommitHash}`, {
                headers: {
                    'User-Agent': '𝙎𝙃𝙄𝙍𝘼𝙃_𝘼𝙄'
                },
                timeout: 10000
