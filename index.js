...
const ownerNumber = ['256747122756']
let store;
...
async function connectToWA() {
  console.log("[🔐] 𝙎𝙃𝙄𝙍𝘼𝙃_𝘼𝙄 Connecting to WhatsApp ⏳️...");
  ...
  conn.ev.on('connection.update', async (update) => {
    ...
    if (connection === 'close') {
      ...
      console.log('[🔐] 𝙎𝙃𝙄𝙍𝘼𝙃_𝘼𝙄 connected to WhatsApp ✅');
      ...
      for (const call of calls) {
        ...
        try {
          await conn.sendMessage(from, {
            text: config.REJECT_MSG || '𝗔𝗠 *𝗦𝗛𝗜𝗥𝗔𝗛_𝗔𝗜*  📵 𝗦𝗧𝗢𝗣 𝗖𝗔𝗟𝗟𝗜𝗡𝗚 𝗠𝗬 𝗢𝗪𝗡𝗘𝗥 𝗜𝗦 𝗦𝗧𝗜𝗟𝗟 𝗕𝗨𝗦𝗬 𝗜𝗙 𝗬𝗢𝗨𝗥 𝗡𝗘𝗘𝗗 𝗛𝗘𝗟𝗣 𝗧𝗬𝗣𝗘 𝗗𝗢𝗡𝗧 𝗖𝗔𝗟𝗟  🚨 𝗜𝗙 𝗬𝗢𝗨 𝗧𝗥𝗬 𝗔𝗚𝗜𝗡 𝗬𝗢𝗨 𝗪𝗘𝗟𝗟 𝗕𝗘 𝗕𝗟𝗢𝗖𝗞𝗘𝗗 🚫*'
          });
        } catch (e) {
    ...
    for (let i of kon) {
      list.push({
        ...
        vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await conn.getName(
          i + '@s.whatsapp.net',
        )}\nFN:${global.OwnerName || ''}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Click here to chat\nitem2.EMAIL;type=INTERNET:${global.email || ''}\nitem2.X-ABLabel:GitHub\nitem3.URL:https://github.com/${global.github || ''}/𝙎𝙃𝙄𝙍𝘼𝙃_𝘼𝙄\nitem3.X-ABLabel:GitHub\nitem4.ADR:;;${global.location || ''};;;;\nitem4.X-ABLabel:Region\nEND:VCARD`,
      });
    }
    conn.sendMessage(
      jid,
